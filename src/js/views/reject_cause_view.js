...
var RejectCauseView = window.RejectCauseView = Backbone.View.extend({
    ...
    save: function (e) {
        ...
        this.model.save(null, {
            success: function(model, jqXHR, options) { // eslint-disable-line no-unused-vars
                self.trigger("reject:saved", model);
                self.$dialog.modal('hide');
            },
            error: function(model, jqXHR, options) { // eslint-disable-line no-unused-vars
    ...
    delete: function (e) { // eslint-disable-line no-unused-vars
...
window.RejectCauseIndicatorView = Backbone.View.extend({
    ...
    clicked: function(e) // eslint-disable-line no-unused-vars
    {
...
var RejectCauseIndicatorView = window.RejectCauseIndicatorView,
