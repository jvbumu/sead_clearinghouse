import { RejectCauseIndicatorView_Store, RejectCauseView } from './reject_cause_view.js';
import { default as CollectionDropdownView } from './utility_views.js';
import { SubmissionNavigationView } from './navigation_view.js';
import { AcceptView, RejectView } from './dialog_view.js';

var SubmissionView = window.SubmissionView = Backbone.View.extend({
    ...
    initialize: function (options) {
        ...
        this.rejectsView = new CollectionDropdownView({
            ...
            select_class: "form-control form-control-sm danger",
            ...
            select_style: "display:block-inline;width:200px;"
        });
    ...
    rejectSaved: function(e) // eslint-disable-line no-unused-vars
    {
    ...
    reject_check_clicked: function(a, b) // eslint-disable-line no-unused-vars
    {
