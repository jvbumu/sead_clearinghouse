window.BaseDialogView = window.Backbone.View.extend({
...
window.AcceptOrRejectView = window.BaseDialogView.extend({
...
window.AcceptView = window.AcceptOrRejectView.extend({
...
window.RejectView = window.AcceptOrRejectView.extend({
...
window.ErrorView = window.BaseDialogView.extend({
