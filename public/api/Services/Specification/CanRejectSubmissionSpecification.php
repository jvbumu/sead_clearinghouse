...
namespace Services\Specification {
    ...
    class CanRejectSubmissionSpecification extends \Services\ServiceBase
    {
        ...
        public function IsSatisfiedBy($submission)
        {
            ...
            if (count($submission["rejects"]) == 0) {
                throw new \InfraStructure\SEAD_Exception("Reject operation denied since submission has no reject causes");
            }
            return true;
        }
     }
