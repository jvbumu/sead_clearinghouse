@Echo Off
SET SOURCE_DIR="C:\Users\roma0050\Google Drive\Project\Projects\VISEAD (Humlab)\SEAD Ceramics & Dendro\Scripts\output"
SET SOURCE_FILE=ceramics_20180103-112825_tidy.xml
