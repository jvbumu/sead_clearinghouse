...
/*****************************************************************************************************************************
**	Function	DEPREACTED fn_clearinghouse_check_submission_length_exceeded
**	Who			Roger Mähler
...
End $$ Language plpgsql;
/*****************************************************************************************************************************
**	Function	DEPRECATED fn_get_schema_table_column_names
**	Who			Roger Mähler
**	When		2013-10-14
...
-- End $$ Language plpgsql;
/*****************************************************************************************************************************
**	Function	DEPRECATED NOT USED!fn_to_integer
**	Who			Roger Mähler
**	When		2013-10-14
**	What
**	Uses
