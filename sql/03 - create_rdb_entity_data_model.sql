...
Create Or Replace Function clearing_house.fn_create_public_db_entity_tables(target_schema character varying(255)) Returns void As $$
...
**	Revisions
******************************************************************************************************************************/
-- Select clearing_house.fn_create_local_union_public_entity_views('clearing_house', 'clearing_house')
-- Select * From clearing_house.tbl_clearinghouse_SEAD_Create_View_Log
Create Or Replace Function clearing_house.fn_create_local_union_public_entity_views(target_schema character varying(255), local_schema character varying(255)) Returns void As $$
...
Begin
	Return Query
        ...
        Select 'Create Index idx_' || target_constraint_name || ' On clearing_house.' || target_table || ' (' || target_colname || ');' 
        From (
